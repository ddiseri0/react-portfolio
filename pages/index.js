      ...
      <main className="bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40 ">
        <section className="min-h-screen">
          ...
          <div className="text-center p-10">
            <h2 className="text-5xl py-2 text-teal-600 font-medium dark:text-teal-400 md:text-6xl">Davide Di Serio</h2>
            <h3 className="text-2xl py-2 dark:text-white md:text-3xl">Graduating student in Computer Engineering</h3>
        ...
        <section>
          <div className="lg:flex gap-10">
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10  dark:bg-white flex-1">
              ...
              <h4 className="py-4 text-teal-600">Working with me means</h4>
              <p className="text-gray-800 py-1">Team-Working</p>
              <p className="text-gray-800 py-1">Comunication</p>
              <p className="text-gray-800 py-1">Collaboration</p>
